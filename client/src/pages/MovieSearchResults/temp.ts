const tempSearch = [
  ...
  },
  {
    ...
    overview:
      "On July 9th GCW presents Fight Club Houston straight from Premier Arena in Houston, Texas. The lineup is almost completed, check it below:  AJ Gray vs Bryan Keith\r Nick Gage vs Sadika\r Joey Janela vs Dante  Ninja Mack vs Jack Cartwheel\r Effy vs Gino\r Jimmy Lloyd vs Carter  Lucha Scramble\r .... more to be added soon!",
    popularity: 0.6,
  ...
  },
  {
    ...
    id: 900801,
    original_language: "en",
    original_title: "Fight Club Rush 10",
    overview:
